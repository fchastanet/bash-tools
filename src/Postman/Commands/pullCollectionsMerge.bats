...
# shellcheck source=src/Postman/Commands/pullCollectionsSingle.sh
source "${rootDir}/src/Postman/Commands/pullCollectionsSingle.sh"
...
function Postman::Commands::pullCollectionsSingle::noRefsSpecified { #@test
  run Postman::Commands::pullCollectionsSingle modelFile 2>&1
  assert_failure 2
  assert_output ""
}

function Postman::Commands::pullCollectionsSingle::collectionRefNotExisting { #@test
  Postman::checkApiKey() {
  ...
  run Postman::Commands::pullCollectionsSingle modelFile ref1 2>&1
...
function Postman::Commands::pullCollectionsSingle::collectionRefIsPulled { #@test
  Postman::checkApiKey() {
    echo "$@" >"${BATS_TEST_TMPDIR}/checkApiKey"
  }
  Postman::api() {

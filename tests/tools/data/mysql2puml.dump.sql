...
--
-- Table structure for table `learnerattribute`
--
...
CREATE TABLE `learnerattribute` (
  ...
  PRIMARY KEY (`id`),
  KEY `learnerattribute_learner_id_fk_learner_id` (`learner_id`),
  KEY `learnerattribute_attribute_id_fk_attribute_id` (`attribute_id`),
  CONSTRAINT `learnerattribute_learner_id_fk_learner_id` FOREIGN KEY (`learner_id`) REFERENCES `learner` (`id`),
  CONSTRAINT `learnerattribute_attribute_id_fk_attribute_id` FOREIGN KEY (`attribute_id`) REFERENCES `attribute` (`id`)
